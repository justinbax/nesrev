...
extern inline void branch(CPU *cpu, bool condition) {
	switch (cpu->step) {
		...
		// TODO ???
		case 2: read(PROGCOUNTER(cpu)); cpu->PCL += ((cpu->temp & 0b10000000) > 0 ? cpu->temp - 256 : cpu->temp); if (!(((cpu->temp & 0b10000000) == 0 && cpu->PCL < cpu->temp) || ((cpu->temp & 0b10000000) > 0 && cpu->PCL > (~cpu->temp) + 1))) checkInterrupts(cpu); END(cpu); break;
...
extern inline void tickCPU(CPU *cpu) {
	...
	if (cpu->step == 0) {
		...
		switch ((cpu->step << 8) | cpu->IR) {
			...
			case 0x01 | (0b101 << 8): cpu->A |= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x03 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// ORA_ZP
			case 0x05 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x05 | (0b010 << 8): cpu->A |= read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x06 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x07 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x0D | (0b011 << 8): cpu->A |= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x0E | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x0F | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x11 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x11 | (0b101 << 8): cpu->A |= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x13 | (0b110 << 8): write(DATAPTR(cpu), cpu->B); cpu->carryFlag = cpu->B & 0b10000000; cpu->B <<= 1; cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// ORA_ZPX
			case 0x15 | (0b001 << 8):
			case 0x15 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0x15 | (0b011 << 8): cpu->A |= read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x16 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x17 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CLC
			case 0x18 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->carryFlag = false; checkInterrupts(cpu); END(cpu); break;

			// ORA_ABY
			case 0x19 | (0b001 << 8):
			case 0x19 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0x19 | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x19 | (0b100 << 8): cpu->A |= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x1B | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// ORA_ABX
			case 0x1D | (0b001 << 8):
			case 0x1D | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0x1D | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x1D | (0b100 << 8): cpu->A |= read(DATAPTR(cpu)); nzFlags(cpu, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x1E | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x1F | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x21 | (0b101 << 8): cpu->A &= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x23 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// BIT_ZP
			case 0x24 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x24 | (0b010 << 8): {uint8_t value = read(0x0000 | cpu->DPL); cpu->oflowFlag = value & 0b01000000; cpu->negFlag = value & 0b10000000; cpu->zeroFlag = !(value & cpu->A);} checkInterrupts(cpu); END(cpu); break;

			// AND_ZP
			case 0x25 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x25 | (0b010 << 8): cpu->A &= read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x26 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x27 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// PLP
			case 0x28 | (0b001 << 8): read(PROGCOUNTER(cpu)); break;
			case 0x28 | (0b010 << 8): pull(cpu); break;
			case 0x28 | (0b011 << 8): checkInterrupts(cpu); {uint8_t flags = read(0x0100 | cpu->SP); cpu->negFlag = flags & 0b10000000; cpu->oflowFlag = flags & 0b01000000; cpu->decFlag = flags & 0b00001000; cpu->noIRQFlag = flags & 0b00000100; cpu->zeroFlag = flags & 0b00000010; cpu->carryFlag = flags & 0b00000001;} END(cpu); break;

			// AND_IMM
			case 0x29 | (0b001 << 8): cpu->A &= fetch(cpu); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// ROL
			case 0x2A | (0b001 << 8): read(PROGCOUNTER(cpu)); if (cpu->carryFlag) {cpu->carryFlag = cpu->A & 0b10000000; cpu->A <<= 1; cpu->A++;} else {cpu->carryFlag = cpu->A & 0b10000000; cpu->A <<= 1;} nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// BIT_ABS
			case 0x2C | (0b001 << 8):
			case 0x2C | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x2C | (0b011 << 8): {uint8_t value = read(DATAPTR(cpu)); cpu->oflowFlag = value & 0b01000000; cpu->negFlag = value & 0b10000000; cpu->zeroFlag = !(value & cpu->A);} checkInterrupts(cpu); END(cpu); break;

			// AND_ABS
			case 0x2D | (0b001 << 8):
			case 0x2D | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x2D | (0b011 << 8): cpu->A &= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x2E | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x2F | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x31 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A &= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x31 | (0b101 << 8): cpu->A &= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x33 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// AND_ZPX
			case 0x35 | (0b001 << 8):
			case 0x35 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0x35 | (0b011 << 8): cpu->A &= read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x36 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x37 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// SEC
			case 0x38 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->carryFlag = true; checkInterrupts(cpu); END(cpu); break;

			// AND_ABY
			case 0x39 | (0b001 << 8):
			case 0x39 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0x39 | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A &= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x39 | (0b100 << 8): cpu->A &= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x3B | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// AND_ABX
			case 0x3D | (0b001 << 8):
			case 0x3D | (0b010 << 8): absAddressing(cpu, cpu->X);
			case 0x3D | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {cpu->A &= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x3D | (0b100 << 8): cpu->A &= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x3E | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x3F | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x40 | (0b101 << 8): cpu->PCH = read(0x0100 | cpu->SP); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x41 | (0b101 << 8): cpu->A ^= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x43 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// EOR_ZP
			case 0x45 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x45 | (0b010 << 8): cpu->A ^= read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x46 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x47 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			// LSR
			case 0x4A | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->carryFlag = cpu->A & 0b00000001; cpu->A >>= 1; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x4D | (0b011 << 8): cpu->A ^= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x4E | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x4F | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x51 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x51 | (0b101 << 8): cpu->A ^= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x53 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// EOR_ZPX
			case 0x55 | (0b001 << 8):
			case 0x55 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0x55 | (0b011 << 8): cpu->A ^= read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x56 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x57 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CLI
			case 0x58 | (0b001 << 8): read(PROGCOUNTER(cpu)); checkInterrupts(cpu); cpu->noIRQFlag = false; END(cpu); break;

			// EOR_ABY
			case 0x59 | (0b001 << 8):
			case 0x59 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0x59 | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x59 | (0b100 << 8): cpu->A ^= read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x5B | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// EOR_ABX
			case 0x5D | (0b001 << 8):
			case 0x5D | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0x5D | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {cpu->A |= cpu->B; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0x5D | (0b100 << 8): cpu->A ^= read(DATAPTR(cpu)); nzFlags(cpu, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x5E | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x5F | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x61 | (0b101 << 8): add(cpu, read(DATAPTR(cpu))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x63 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// ADC_ZP
			case 0x65 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x65 | (0b010 << 8): add(cpu, read(0x0000 | cpu->DPL)); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x66 | (0b100 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x67 | (0b011 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			// ROR
			case 0x6A | (0b001 << 8): read(PROGCOUNTER(cpu)); if (cpu->carryFlag) {cpu->carryFlag = cpu->A & 0b00000001; cpu->A >>= 1; cpu->A |= 0b10000000;} else {cpu->carryFlag = cpu->A & 0b00000001; cpu->A >>= 1;} checkInterrupts(cpu); END(cpu); break;
			...
			case 0x6C | (0b100 << 8): cpu->PCH = read(DATAPTR(cpu)); cpu->PCL = cpu->temp; checkInterrupts(cpu); END(cpu); break;

			// ADC_ABS
			case 0x6D | (0b001 << 8):
			case 0x6D | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x6D | (0b011 << 8): add(cpu, read(DATAPTR(cpu))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x6E | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x6F | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x71 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {add(cpu, cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0x71 | (0b101 << 8): add(cpu, read(DATAPTR(cpu))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x73 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// ADC_ZPX
			case 0x75 | (0b001 << 8):
			case 0x75 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0x75 | (0b011 << 8): add(cpu, read(0x0000 | cpu->DPL)); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x76 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x77 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// SEI
			case 0x78 | (0b001 << 8): read(PROGCOUNTER(cpu)); checkInterrupts(cpu); cpu->noIRQFlag = true; END(cpu); break;

			// ADC_ABY
			case 0x79 | (0b001 << 8):
			case 0x79 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0x79 | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {add(cpu, cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0x79 | (0b100 << 8): add(cpu, read(DATAPTR(cpu))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x7B | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// ADC_ABX
			case 0x7D | (0b001 << 8):
			case 0x7D | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0x7D | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {add(cpu, cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0x7D | (0b100 << 8): add(cpu, read(DATAPTR(cpu))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x7E | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x7F | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x81 | (0b101 << 8): write(DATAPTR(cpu), cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x83 | (0b101 << 8): write(DATAPTR(cpu), cpu->A & cpu->X); checkInterrupts(cpu); END(cpu); break;

			// STY_ZP
			case 0x84 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x84 | (0b010 << 8): write(0x0000 | cpu->DPL, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// STY_ZP
			case 0x85 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x85 | (0b010 << 8): write(0x0000 | cpu->DPL, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// STY_ZP
			case 0x86 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x86 | (0b010 << 8): write(0x0000 | cpu->DPL, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// STY_ZP
			case 0x87 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0x87 | (0b010 << 8): write(0x0000 | cpu->DPL, cpu->A & cpu->X); checkInterrupts(cpu); END(cpu); break;

			// DEY
			case 0x88 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->Y--; nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;
			
			// TXA
			case 0x8A | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->A = cpu->X; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x8C | (0b011 << 8): write(DATAPTR(cpu), cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// STA_ABS
			case 0x8D | (0b001 << 8):
			case 0x8D | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x8D | (0b011 << 8): write(DATAPTR(cpu), cpu->A); checkInterrupts(cpu); END(cpu); break;

			// STX_ABS
			case 0x8E | (0b001 << 8):
			case 0x8E | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x8E | (0b011 << 8): write(DATAPTR(cpu), cpu->X); checkInterrupts(cpu); END(cpu); break;

			// SAX_ABS
			case 0x8F | (0b001 << 8):
			case 0x8F | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x8F | (0b011 << 8): write(DATAPTR(cpu), cpu->A & cpu->X); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x91 | (0b101 << 8): write(DATAPTR(cpu), cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x93 | (0b101 << 8): write(DATAPTR(cpu), cpu->A & cpu->X & cpu->temp); checkInterrupts(cpu); END(cpu); break;

			// STY_ZPX
			case 0x94 | (0b001 << 8):
			case 0x94 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0x94 | (0b011 << 8): write(0x0000 | cpu->DPL, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// STA_ZPX
			case 0x95 | (0b001 << 8):
			case 0x95 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0x95 | (0b011 << 8): write(0x0000 | cpu->DPL, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// STX_ZPY
			case 0x96 | (0b001 << 8):
			case 0x96 | (0b010 << 8): zpiAddressing(cpu, cpu->Y); break;
			case 0x96 | (0b011 << 8): write(0x0000 | cpu->DPL, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// SAX_ZPY
			case 0x97 | (0b001 << 8):
			case 0x97 | (0b010 << 8): zpiAddressing(cpu, cpu->Y); break;
			case 0x97 | (0b011 << 8): write(0x0000 | cpu->DPL, cpu->A & cpu->X); checkInterrupts(cpu); END(cpu); break;

			// TYA
			case 0x98 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->A = cpu->Y; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// STA_ABY
			case 0x99 | (0b001 << 8):
			case 0x99 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0x99 | (0b011 << 8): read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; break;
			case 0x99 | (0b100 << 8): write(DATAPTR(cpu), cpu->A); checkInterrupts(cpu); END(cpu); break;

			// TXS
			case 0x9A | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->SP = cpu->X; checkInterrupts(cpu); END(cpu); break;
			...
			case 0x9B | (0b100 << 8): write(DATAPTR(cpu), cpu->A & cpu->X & cpu->temp); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x9C | (0b100 << 8): write(DATAPTR(cpu), cpu->X & cpu->temp); checkInterrupts(cpu); END(cpu); break;

			// STA_ABX
			case 0x9D | (0b001 << 8):
			case 0x9D | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0x9D | (0b011 << 8): read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; break;
			case 0x9D | (0b100 << 8): write(DATAPTR(cpu), cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x9E | (0b100 << 8): write(DATAPTR(cpu), cpu->X & cpu->temp); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x9F | (0b100 << 8): write(DATAPTR(cpu), cpu->A & cpu->X & cpu->temp); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xA1 | (0b101 << 8): cpu->A = read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xA3 | (0b101 << 8): cpu->X = read(DATAPTR(cpu)); cpu->A = cpu->X; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// LDY_ZP
			case 0xA4 | (0b001 << 8): cpu->DPL = fetch(cpu);
			case 0xA4 | (0b010 << 8): cpu->Y = read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// LDA_ZP
			case 0xA5 | (0b001 << 8): cpu->DPL = fetch(cpu);
			case 0xA5 | (0b010 << 8): cpu->A = read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// LDX_ZP
			case 0xA6 | (0b001 << 8): cpu->DPL = fetch(cpu);
			case 0xA6 | (0b010 << 8): cpu->X = read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// LAX_ZP
			case 0xA7 | (0b001 << 8): cpu->DPL = fetch(cpu);
			case 0xA7 | (0b010 << 8): cpu->X = read(0x0000 | cpu->DPL); cpu->A = cpu->X; nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// TAY
			case 0xA8 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->Y = cpu->A; nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// LDA_IMM
			case 0xA9 | (0b001 << 8): cpu->A = fetch(cpu); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// TAX
			case 0xAA | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->X = cpu->A; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xAC | (0b011 << 8): cpu->Y = read(DATAPTR(cpu)); nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// LDA_ABS
			case 0xAD | (0b001 << 8):
			case 0xAD | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0xAD | (0b011 << 8): cpu->A = read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// LDX_ABS
			case 0xAE | (0b001 << 8):
			case 0xAE | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0xAE | (0b011 << 8): cpu->X = read(DATAPTR(cpu)); nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// LAX_ABS
			case 0xAF | (0b001 << 8):
			case 0xAF | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0xAF | (0b011 << 8): cpu->X = read(DATAPTR(cpu)); cpu->A = cpu->X; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xB1 | (0b100 << 8): cpu->A = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			...
			case 0xB3 | (0b100 << 8): cpu->X = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A = cpu->X; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu);} break;
			...
			case 0xB4 | (0b011 << 8): cpu->Y = read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// LDA_ZPX
			case 0xB5 | (0b001 << 8):
			case 0xB5 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0xB5 | (0b011 << 8): cpu->A = read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// LDX_ZPY
			case 0xB6 | (0b001 << 8):
			case 0xB6 | (0b010 << 8): zpiAddressing(cpu, cpu->Y); break;
			case 0xB6 | (0b011 << 8): cpu->X = read(0x0000 | cpu->DPL); nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// LAX_ZPY
			case 0xB7 | (0b001 << 8):
			case 0xB7 | (0b010 << 8): zpiAddressing(cpu, cpu->Y); break;
			case 0xB7 | (0b011 << 8): cpu->X = read(0x0000 | cpu->DPL); cpu->A = cpu->X; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// CLV
			case 0xB8 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->oflowFlag = false; checkInterrupts(cpu); END(cpu); break;

			// LDA_ABY
			case 0xB9 | (0b001 << 8):
			case 0xB9 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0xB9 | (0b011 << 8): cpu->A = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0xB9 | (0b100 << 8): cpu->A = read(DATAPTR(cpu)); checkInterrupts(cpu); END(cpu); break;

			// TSX
			case 0xBA | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->X = cpu->SP; checkInterrupts(cpu); END(cpu); break;

			// LAS_ABY
			case 0xBB | (0b001 << 8):
			case 0xBB | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0xBB | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->SP &= cpu->B; cpu->A = cpu->SP; cpu->X = cpu->SP; nzFlags(cpu, cpu->SP); checkInterrupts(cpu); END(cpu);} break;
			case 0xBB | (0b100 << 8): cpu->SP &= read(DATAPTR(cpu)); cpu->A = cpu->SP; cpu->X = cpu->SP; nzFlags(cpu, cpu->SP); checkInterrupts(cpu); END(cpu); break;

			// LDY_ABX
			case 0xBC | (0b001 << 8):
			case 0xBC | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0xBC | (0b011 << 8): cpu->Y = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu);} break;
			case 0xBC | (0b100 << 8): cpu->Y = read(DATAPTR(cpu)); nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// LDA_ABX
			case 0xBD | (0b001 << 8):
			case 0xBD | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0xBD | (0b011 << 8): cpu->A = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu);} break;
			case 0xBD | (0b100 << 8): cpu->A = read(DATAPTR(cpu)); nzFlags(cpu, cpu->A); checkInterrupts(cpu); END(cpu); break;

			// LDX_ABY
			case 0xBE | (0b001 << 8):
			case 0xBE | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0xBE | (0b011 << 8): cpu->X = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu);} break;
			case 0xBE | (0b100 << 8): cpu->X = read(DATAPTR(cpu)); nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;

			// LAX_ABY
			case 0xBF | (0b001 << 8):
			case 0xBF | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0xBF | (0b011 << 8): cpu->X = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->A = cpu->X; nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu);} break;
			case 0xBF | (0b100 << 8): cpu->X = read(DATAPTR(cpu)); cpu->A = cpu->X; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xC1 | (0b101 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xC3 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CPY_ZP
			case 0xC4 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0xC4 | (0b010 << 8): cpu->B = read(0x0000 | cpu->DPL); cpu->carryFlag = cpu->Y >= cpu->B; nzFlags(cpu, cpu->Y - cpu->B); checkInterrupts(cpu); END(cpu); break;
			
			// CMP_ZP
			case 0xC5 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0xC5 | (0b010 << 8): cpu->B = read(0x0000 | cpu->DPL); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xC6 | (0b011 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xC7 | (0b011 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// INY
			case 0xC8 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->Y++; nzFlags(cpu, cpu->Y); checkInterrupts(cpu); END(cpu); break;

			// CMP_IMM
			case 0xC9 | (0b001 << 8): cpu->B = fetch(cpu); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			
			// DEX
			case 0xCA | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->X--; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xCC | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->Y >= cpu->B; nzFlags(cpu, cpu->Y - cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CMP_ABS
			case 0xCD | (0b001 << 8):
			case 0xCD | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0xCD | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xCE | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xCF | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xD1 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0xD1 | (0b101 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xD3 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CMP_ZPX
			case 0xD5 | (0b001 << 8):
			case 0xD5 | (0b010 << 8): zpiAddressing(cpu, cpu->X);
			case 0xD5 | (0b011 << 8): cpu->B = read(0x0000 | cpu->DPL); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xD6 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xD7 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CLD
			case 0xD8 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->decFlag = false; checkInterrupts(cpu); END(cpu); break;

			// CMP_ABY
			case 0xD9 | (0b001 << 8):
			case 0xD9 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0xD9 | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0xD9 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xDB | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			
			// CMP_ABX
			case 0xDD | (0b001 << 8):
			case 0xDD | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0xDD | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0xDD | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->A >= cpu->B; nzFlags(cpu, cpu->A - cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xDE | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xDF | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xE1 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xE3 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// CPX_ZP
			case 0xE4 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0xE4 | (0b010 << 8): cpu->B = read(0x0000 | cpu->DPL); cpu->carryFlag = cpu->X >= cpu->B; nzFlags(cpu, cpu->X - cpu->B); checkInterrupts(cpu); END(cpu); break;
			
			// SBC_ZP
			case 0xE5 | (0b001 << 8): cpu->DPL = fetch(cpu); break;
			case 0xE5 | (0b010 << 8): add(cpu, ~(read(0x0000 | cpu->DPL))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xE6 | (0b011 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xE7 | (0b011 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// INX
			case 0xE8 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->X++; nzFlags(cpu, cpu->X); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xEC | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); cpu->carryFlag = cpu->X >= cpu->B; nzFlags(cpu, cpu->X - cpu->B); checkInterrupts(cpu); END(cpu); break;
			
			// SBC_ABS
			case 0xED | (0b001 << 8):
			case 0xED | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0xED | (0b011 << 8): add(cpu, ~(read(DATAPTR(cpu)))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xEE | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xEF | (0b101 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xF1 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {add(cpu, ~cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0xF1 | (0b101 << 8): add(cpu, ~(read(DATAPTR(cpu)))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xF3 | (0b111 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			
			// SBC_ZPX
			case 0xF5 | (0b001 << 8):
			case 0xF5 | (0b010 << 8): zpiAddressing(cpu, cpu->X); break;
			case 0xF5 | (0b011 << 8): add(cpu, ~(read(0x0000 | cpu->DPL))); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xF6 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xF7 | (0b101 << 8): write(0x0000 | cpu->DPL, cpu->B); checkInterrupts(cpu); END(cpu); break;

			// SED
			case 0xF8 | (0b001 << 8): read(PROGCOUNTER(cpu)); cpu->decFlag = true; checkInterrupts(cpu); END(cpu); break;

			// SBC_ABY
			case 0xF9 | (0b001 << 8):
			case 0xF9 | (0b010 << 8): absAddressing(cpu, cpu->Y); break;
			case 0xF9 | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->Y) cpu->DPH++; else {add(cpu, ~cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0xF9 | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); add(cpu, ~cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xFB | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;

			// SBC_ABX
			case 0xFD | (0b001 << 8):
			case 0xFD | (0b010 << 8): absAddressing(cpu, cpu->X); break;
			case 0xFD | (0b011 << 8): cpu->B = read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {add(cpu, ~cpu->B); checkInterrupts(cpu); END(cpu);} break;
			case 0xFD | (0b100 << 8): cpu->B = read(DATAPTR(cpu)); add(cpu, ~cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xFE | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xFF | (0b110 << 8): write(DATAPTR(cpu), cpu->B); checkInterrupts(cpu); END(cpu); break;
			...
			case 0xDA | (0b001 << 8):
			case 0xEA | (0b001 << 8):
			case 0xFA | (0b001 << 8): read(PROGCOUNTER(cpu)); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x04 | (0b010 << 8):
			case 0x44 | (0b010 << 8):
			case 0x64 | (0b010 << 8): read(0x0000 | cpu->DPL); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x74 | (0b011 << 8):
			case 0xD4 | (0b011 << 8):
			case 0xF4 | (0b011 << 8): read(0x0000 | cpu->DPL); checkInterrupts(cpu); END(cpu); break;

			// NOP_ABS
			case 0x0C | (0b001 << 8):
			case 0x0C | (0b010 << 8): absAddressing(cpu, 0); break;
			case 0x0C | (0b011 << 8): read(DATAPTR(cpu)); checkInterrupts(cpu); END(cpu); break;
			...
			case 0x7C | (0b011 << 8):
			case 0xDC | (0b011 << 8):
			case 0xFC | (0b011 << 8): read(DATAPTR(cpu)); if (cpu->DPL < cpu->X) cpu->DPH++; else {checkInterrupts(cpu); END(cpu);} break;
			case 0x1C | (0b100 << 8):
			case 0x3C | (0b100 << 8):
			case 0x5C | (0b100 << 8):
			case 0x7C | (0b100 << 8):
			case 0xDC | (0b100 << 8):
			case 0xFC | (0b100 << 8): read(DATAPTR(cpu)); checkInterrupts(cpu); END(cpu); break;
